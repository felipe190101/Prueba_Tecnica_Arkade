...
public class UpdatePrealerta extends JDialog {
    ...
    private void initComponents(ActionListener listener){
        ...
        JLabel textId = new JLabel("Seleccione la prealerta a editar");
        constraints.gridx = 0;
        constraints.gridy = 0;
        ...
        constraints.gridx = 0;
        constraints.gridy = 1;
        add(prealertaComboBox,constraints);

        JLabel textName = new JLabel("Ingrese el nuevo nombre de la prealerta:");
        constraints.gridx = 0;
        constraints.gridy = 2;
        ...
        JLabel textGuide = new JLabel("Ingrese la nueva guia de la prealerta:");
        constraints.gridx = 0;
        constraints.gridy = 4;
        ...
        okButton.setActionCommand(Events.UPDATE_PREALERTA.name());
        constraints.gridx = 0;
        constraints.gridy = 6;
